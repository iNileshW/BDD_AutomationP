...
//Global hooks
//2 Types of hooks: Global & Local. Global is @Before(), @After(). These are run for all scenarios. 
//Local hooks are e.g. @Before('@First'). So this scenario will run only for First scenario after global before is run. Precondition only for that scenario
